$(function() {
    ...
    $('.toggle-meter').on('click', function(){
      ...
      $.post('http://esx_taxijob/updateAttrs', JSON.stringify(attrs));
    });
    ...
    $('.close').on('click', function(){
      $.post('http://esx_taxijob/closeConfig', JSON.stringify({}));
    });
  
    $('.set-rate').on('click', function(){
      $.post('http://esx_taxijob/setRate', JSON.stringify({}));
    });
  
    $('.reset-trip').on('click', function(){
      $.post('http://esx_taxijob/resetFare', JSON.stringify({}));
    });
