        ...
        categories = {
            {
                title = 'Food',
                products = {
                    { label = 'Double Tender Burger', name = 'doubletender', price = 4.95, image = 'https://imgur.com/vyfT3lj.png' },
                    { label = 'Original Recipe Burger', name = 'originalrecipe', price = 6.45, image = 'https://imgur.com/ter7EL7.png' },
                    { label = 'Original Twister', name = 'twister', price = 7.45, image = 'https://imgur.com/HcqZ9ZB.png' },
                    { label = 'Zinger Stacker Burger', name = 'zingerburger', price = 9.45, image = 'https://imgur.com/mPDcKRW.png' },
                    { label = 'Zinger Stacker Burger Box', name = 'zingerstacker', price = 16.45, image = 'https://imgur.com/j0BzzAk.png' },
                    { label = '10 KFC Nuggets', name = 'kfcnuggets', price = 8.95, image = 'https://imgur.com/l5cup7P.png' },
                    { label = 'Maxi Popcorn Chicken', name = 'popcornchicken', price = 7.95, image = 'https://imgur.com/R9nckRH.png' },
                }
            },  
            {
                title = 'Drinks',
                products = {
                    { label = '600ml Pepsi Max', name = 'pepsimax', price = 4.45, image = 'https://imgur.com/MZ8mXV9.png' },
                    { label = '600ml Mountain Dew', name = 'mountaindew', price = 4.45, image = 'https://imgur.com/yHkoP3v.png' },
                    { label = 'Large Mountain Dew Freeze', name = 'mountaindewfreeze', price = 1, image = 'https://imgur.com/fqdy8YZ.png' },
                    { label = 'Large Raspberry Freeze', name = 'raspberryfreeze', price = 1, image = 'https://imgur.com/ePj0LzJ.png' },
                    { label = 'Large Pepsi Freeze', name = 'pepsifreeze', price = 1, image = 'https://imgur.com/2uFilk8.png' },
                    { label = 'Lipton Icea Tea', name = 'icedtea', price = 4.45, image = 'https://imgur.com/lmqsm8w.png' },
                    { label = '500ml Mt Franklin Water', name = 'water', price = 3.45, image = 'https://imgur.com/H7Xa2Dv.png' },
                }
            },
            {
                title = 'Sides',
                products = {
                    { label = 'Nugget Go Bucket', name = 'nuggetgobucket', price = 4.45, image = 'https://imgur.com/mSO2ajP.png' },
                    { label = 'Popcorn Go Bucket', name = 'popcornbucket', price = 4.45, image = 'https://imgur.com/loLmDnx.png' },
                    { label = 'Potato & Gravy', name = 'potatogravy', price = 6.95, image = 'https://imgur.com/Aea9Pv1.png' },
                    { label = 'Dinner Roll', name = 'dinnerroll', price = 0.95, image = 'https://imgur.com/5XeJO7Z.png' },
                    { label = 'Large Chips', name = 'largechips', price = 4.95, image = 'https://imgur.com/tXbb8AU.png' },
                    { label = '3 Wicked Wings', name = 'wickedwings', price = 3.45, image = 'https://imgur.com/DXwLiEQ.png' },
                    { label = '6 Pieces Original Recipe', name = 'chicken', price = 15.45, image = 'https://imgur.com/O3lzKeu.png' },
                    { label = '3 Original Tenders', name = 'tenders', price = 6.95, image = 'https://imgur.com/0G4zaAS.png' },
                    { label = 'Pepper Mayo Slider', name = 'slider', price = 2.95, image = 'https://imgur.com/VaSFLmP.png' },
                }
            }
        },
